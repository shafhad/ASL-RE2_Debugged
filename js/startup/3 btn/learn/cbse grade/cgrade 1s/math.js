class Mat{
    ...
    display(){
        ...
        this.speak.position(displayWidth/2-170,displayHeight/2+180);
        this.speak.mousePressed(()=>{
            var sp = new p5.Speech(); // speech synthesis object
            sp.speak('What Is Addition? Addition means altogether, counting of two groups of objects and finding how many in all. Example: 5 + 11 = 16 is addition... Addend... Sum or Total. TRY THESE YOURSELVES'); // say something
        })
